...
const cli = meow(
  `
	Usage
	  $ npx zira-gltfjsx [Model.glb] [options]

	Options
    --output, -o        Output file name/path
    --transformoutput -O Transform output file name/path
    --ref, -g           Forward ref
    ...
    --preload, -P       preload models
    --exportdata, -e    export user data seperately
...
`,
  {
    ...
    flags: {
      ...
      transformoutput: { type: 'string', shortFlag: 'O' },
      ...
      printwidth: { type: 'number', shortFlag: 'w', default: 1000 },
      ...
      ref: { type: 'boolean', default: false, shortFlag: 'g' },
      preload: { type: 'boolean', default: true, shortFlag: 'P' },
      exportdata: { type: 'boolean', default: false, shortFlag: 'e' },
...
if (cli.input.length === 0) {
  ...
  const config = {
    ...cli.flags,
    header: `Auto-generated by: https://github.com/zira-games/gltfjsx
Command: npx zira-gltfjsx@${packageJson.version} ${process.argv.slice(2).join(' ')}`,
  }
